...
\section*{Part 1: Principles of OOP}
...
\shortanswer[1.0in]{Place the four access modifiers in order, starting with the highest level of encapsulation.}
...
\shortanswer[0.75in]{Which keyword is used to inherit a class in Java?}

\shortanswer[0.75in]{What operator can be used to check the type of an object?}
...
\section*{Week 3: Polymorphism and ADTs}
...
\section*{Week 5: GUIs, JavaFX, and MVC}
...
\section*{Wrap-Up: Code Tracing}

\question {[Lecture 01, 02, 04] What will be the output of this code?}
\begin{verbatim}
class Book {
    String title;
    double price;
...
\question {[Lecture 04, 07] What will be the output of this code?}
\begin{verbatim}
class Course {
...
\question {[Lecture 06, 07] What will be the output of this code?}
\begin{verbatim}
interface Club {
    void join();
}
...
\question {[Lecture 08] What is the output of the following code?}
\begin{verbatim}
...
\question {[Lecture 09] What is the output of the following code?}
\begin{verbatim}
...
\question {[Lecture 10] What is the output of the following code?}
\begin{verbatim}
public class Main {
    public static void main(String[] args) {
        try {
...
\question {[Lecture 11] What is the output of the following code?}
\begin{verbatim}
import java.io.*;
...
\question {[Lecture 04, 07] Which of the following lines cause an exception (i.e. are invalid) if left in? Select any that apply.}
\begin{verbatim}
class Building {}
...
\question {[Lecture 12, 13, 14] What should we replace line 19 with to achieve the intended functionality of this JavaFX program?}
\begin{verbatim}
